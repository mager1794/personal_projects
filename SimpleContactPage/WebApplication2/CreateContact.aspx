<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateContact.aspx.cs" Inherits="WebApplication2.EditContact" %>
...
<body style="margin:0 0 0 0; background-color:beige;">
    ...
    <div style="font-size:17px; margin-top:20px;">
        <form method="post" action="CreateContact.aspx" id="editcontact" runat="server">
            <div id="container">
           ...
           <div style="clear: both; margin-top:15px; display:inline; float:left; margin-left:20px;">
            ...
            <asp:Button runat="server" style="margin-top:230px; margin-left:30px;"  ID="submitbutton" Text="Create Contact" OnClick="submitbutton_Click"/>
            <div id="filler" style="clear: both; width:100%; height:100%; background-color:red; display:block;"></div>
            </div>
        <!-- Regular Expressions -->
